...
public class Main {
    public static void main(String[] args) {
        ...
        /*
            ...
            이라고 합니다.
            하드 코딩 : 명령문에 데이터(변수에 대입되지 않은 데이터인데 이를 리터럴(literal))이라고 표현한다.
        ...
        String introduction = "안녕하세요, 저는 이번 국비 과정을 배우게 된 최병현입니다.";
        ...
        // 근데 71 라인의 경우에 변수의 자료형이 char인데 문자가 여러 개 나오는 바람에 결과값이
        // 의도한대로 나오지 않음.
        ...
        /*
            ...
            문자(하나짜리)를 세 번 더 했을 경우 더 이상 문자가 아니라 문자열로 인식되기 때문에
            원하는 방식으로 출력되지 않습니다.
