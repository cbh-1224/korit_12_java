...
/*
    ...
    Snake case -> Java 에서 쓸 일이 없습니다. 근데 상수 표기에서 피슷하게 사용됨
    Pascal case -> 첫 번째 문자가 대문자고 나머지는 소문자로 가다가
                   두번째 단어의 첫 번째 문자는 대문자
...
public class Operator01 {
    public static void main(String[] args) {
        ...
        System.out.println("내녀에는 " + age + 1 + "살이 됩니다.");
        System.out.println("내녀에는 " + (age + 1) + "살이 됩니다.");
        // 이상의 경우에서 79번 라인은 왜 원하는 결과값이 나오지 않는지 설명하시오. 라고 했을 때 가능한가
