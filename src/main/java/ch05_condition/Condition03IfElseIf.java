...
public class Condition03IfElseIf {
    public static void main(String[] args) {
        ...
        int point; // 0개의 사용위치
        // 상수 개념을 처음 설명합니다 -> 얘는 초기화 필수
        final int VIP_POINT = 100; // final 키워드가 붙으면 '재대입'이 불가능 0개의 사용위치
        final int GOLD_POINT = 80; // 즉, 변함없는 데이터를 사용하고 싶을 때 0개의 사용위치
...
//        }
        ...
        /*
            풀이법 # 1의 경우에는 40점 이하의 포인트를 가지게 될 경우
            실행되는 부분이 없습니다.

            풀이법 #2의 경우에는 반복되는 print문이 없어도 된다는 점에서
            장점을 가지고 있지만 40점 이하인 경우에도 59번 라인이 실행되고,
            40점 이하의 경우 userGrade가 ""에서 변하되지 않기 때문에
            결과값이
            회원 등급:
            이라는 빈칸이 생기게 되는 단점이 있겠습니다.
         */
    }
}
