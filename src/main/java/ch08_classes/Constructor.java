...
public class Constructor {
    ...
    /*
        ...
        그리고 매개변수의 유무만 있고 return이 없어서 call() / call2()
        유형 밖에 없죠 그말은 어차피 return 없어서 void니까 void를 명시하지 않습니다.
    ...
    /*
        ...
        김오 학생의 학번은 5 번 입니다.
        를 콘솔에 출력할 수 있도록 Constructor.java에 display() 메서드를 call1() 유형으로
        작성하고 ConstructorMain에서 호출하시오
     */
