...
/*
    ...
    일반 for문과의 차이점:
        ...
        이를 응용하여 배열 내의 element에 for문 내부에서만 사용하는
        변수에 대입하는 방식을 사용하여 index 넘버의 사용 없이 적용할 수 있는 for
...
public class Array08 {
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            String 배열에 김일, 김이, 김삼, 김사, 김오 라는 element를 가지도록 초기화 배열명 names
