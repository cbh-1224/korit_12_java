...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        /*
            ...
            (Lamda Expression)으로 대체되는 경우가 많습니다(그리고 JavaScript에서도 동일한 방식을 사용)

            재사용하지 않고 한 번만, 즉 이 경우에는 FactoryMain에서만 한 번 쓰고 치운다면 사용하기 좋다.

            저희는 교육 상황이기 때문에 모든 클래스를 한 번 정의하고 그걸로 객체 한 두개 만들고 치우는
        ...
        /*
            ...
            부모 클래스와 자식클래스의 메서드 호출 결과가 '다르게' 굴러 갈 경우에만
        ...
        tableFactory1.setName("구글 테블릿 공장");
        System.out.println("현재 공장은 " + tableFactory1.getName() + "으로 변경되었습니다.");
        tableFactory1.upgrade("아이패드 프로 13인치 8");
        tableFactory1.setName("구글 태블릿");
        tableFactory1.produce("구글 태블릿");
        tableFactory1.manage();
        tableFactory1.upgrade("구글 태블릿 10인치 2");
