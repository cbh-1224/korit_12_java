...
public class AirConditionerController {
    ...
    private ModeCahngeButton modeCahngeButton;
    private PowerButton powerButton;

    public AirConditionerController(TemperatureDownButton temperatureDownButton, TemperatureUpButton temperatureUpButton, ModeCahngeButton modeCahngeButton, PowerButton powerButton) {
        this.temperatureDownButton = temperatureDownButton;
        this.temperatureUpButton = temperatureUpButton;
        this.modeCahngeButton = modeCahngeButton;
